import bookImg from '@/assets/content/home2/Peach-and-Orange-Minimal-Opt-in-Lead-Magnet-Book-Mockup-Blog-Banner-1-e1677184936988.png';
...
export const featuredCourses = [
	{
		...
		bullets: [
			...
			{ text: 'How to have healthy communication', highlight: 'communication' },
			{ text: 'How to live authentically', highlight: 'authentically' },
			{ text: 'How honesty is a superpower', highlight: 'honesty' },
			{ text: 'How to reclaim the lost art of honour', highlight: 'honour' },
		],
		description:
	...
	},
	{
		...
		bullets: [
			...
			{ text: 'How faith can change the way you see yourself', highlight: 'faith' },
			{ text: 'How shame destroys identity and erodes confidence', highlight: 'shame' },
			{ text: 'How to build confidence that lasts forever!', highlight: 'build' },
		],
		description:
