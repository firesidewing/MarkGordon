...
Static marketing site for Mark Gordon (markgordon.ca) built with **Astro 6**, **Svelte 5 islands**, and **Tailwind CSS 4**. No local database, Docker, or `.env` files. Phase 2 (Clerk auth, Turso) is not implemented.
