...
**Persuade** — the visitor decides whether to book Mark to speak.

## Job and audience

Event planners, org leaders, and faith-community buyers land on `/` evaluating a keynote speaker. They have limited attention and compare Mark against generic motivational speakers. They need to understand who he is, what he speaks about, and how to book him — in under 30 seconds.

## Outcome and proof

**Primary action:** Book Mark to Speak (HubSpot discovery / book-now flow).

**Proof on page:** Short testimonial excerpts, 3 featured speaking topics, credibility line (35+ years, author), Why Mark section.
...
|----------|---------|-----------|
| Hero | Book Mark to Speak | Explore Speaking Topics |
| Challenge | Bring Mark to Your Team | — |
| Offerings | Contextual per panel | — |
| Final close | Book Mark to Speak | Start a Conversation |

## Copy anchors (approved direction)

- Hero h1: Healthy Leaders Build Healthy Cultures.
- Tagline: Healthy leaders build healthy cultures.
- Testimonials heading: Leaders Experience the Difference.
- Blind spot: Every Leader Has Blind Spots.
